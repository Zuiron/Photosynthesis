...
public class DryingRackScreenHandler extends ScreenHandler {
    ...
    public DryingRackScreenHandler(int syncId, PlayerInventory playerInventory, Inventory inventory, PropertyDelegate delegate) {
        super(ModScreenHandlers.DRYINGRACK_SCREEN_HANDLER, syncId);
