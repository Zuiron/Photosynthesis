...
public class WoodFiredOvenScreen extends HandledScreen<WoodFiredOvenScreenHandler> {
    private static final Identifier TEXTURE =
            new Identifier(Photosynthesis.MOD_ID, "textures/gui/wood_fired_oven_gui.png");

    public WoodFiredOvenScreen(WoodFiredOvenScreenHandler handler, PlayerInventory inventory, Text title) {
