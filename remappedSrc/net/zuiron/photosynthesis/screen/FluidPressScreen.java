...
public class FluidPressScreen extends HandledScreen<FluidPressScreenHandler> {
    private static final Identifier TEXTURE =
            new Identifier(Photosynthesis.MOD_ID, "textures/gui/fluid_press_gui.png");

    private FluidStackRenderer fluidStackRenderer;

    public FluidPressScreen(FluidPressScreenHandler handler, PlayerInventory inventory, Text title) {
