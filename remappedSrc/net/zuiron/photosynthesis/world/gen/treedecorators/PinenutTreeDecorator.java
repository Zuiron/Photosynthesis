...
public class PinenutTreeDecorator extends TreeDecorator {
    public static final PinenutTreeDecorator INSTANCE = new PinenutTreeDecorator();
    public static final Codec<PinenutTreeDecorator> CODEC = Codec.unit(() -> INSTANCE);
    ...
    public void generate(Generator generator) {
        generator.getLeavesPositions().forEach(pos -> {
            ...
            if(generator.isAir(pos.down()) && chance == 0) {
                generator.replace(pos.offset(Direction.DOWN, 1), ModBlocks.PINENUTTREE_BUSHCROP.getDefaultState());
            }
        });
    }
}
