...
public class ModBlocks {
    ...
    public static final Block FLORAMELISSIA = registerBlock("floramelissia",
            new FlowerBlock(StatusEffects.SATURATION, 7, FabricBlockSettings.copy(Blocks.DANDELION)));
    ...
    /*public static final Block ROOF_BLOCK = registerBlock("roof_block",
    ...
    private static CropBlock registerGrassCropBlockSimple(String name){
        return Registry.register(Registries.BLOCK, new Identifier(Photosynthesis.MOD_ID, name),
                new CustomGrassCropBlock(AbstractBlock.Settings.copy(Blocks.GRASS)
                        .nonOpaque().noCollision().ticksRandomly().breakInstantly().sounds(BlockSoundGroup.GRASS).offset(AbstractBlock.OffsetType.XZ).mapColor(MapColor.DARK_GREEN),
                        name));
    }
