...
public class ModBlocks {
    ...
    public static final CropBlock LETTUCE_CROP = registerCropBlock("lettuce_crop",
            new CustomCropBlock(AbstractBlock.Settings.of(Material.PLANT)
                    .nonOpaque().noCollision().ticksRandomly().breakInstantly().sounds(BlockSoundGroup.CROP),
                    ModItems.LETTUCE_SEEDS));

    public static final CropBlock OKRA_CROP = registerCropBlock("okra_crop",
            new CustomCropBlock(AbstractBlock.Settings.of(Material.PLANT)
                    .nonOpaque().noCollision().ticksRandomly().breakInstantly().sounds(BlockSoundGroup.CROP),
                    ModItems.OKRA_SEEDS));

    public static final CropBlock PARSNIP_CROP = registerCropBlock("parsnip_crop",
            new CustomCropBlock(AbstractBlock.Settings.of(Material.PLANT)
                    .nonOpaque().noCollision().ticksRandomly().breakInstantly().sounds(BlockSoundGroup.CROP),
                    ModItems.PARSNIP_SEEDS));

    public static final CropBlock RADISH_CROP = registerCropBlock("radish_crop",
            new CustomCropBlock(AbstractBlock.Settings.of(Material.PLANT)
                    .nonOpaque().noCollision().ticksRandomly().breakInstantly().sounds(BlockSoundGroup.CROP),
