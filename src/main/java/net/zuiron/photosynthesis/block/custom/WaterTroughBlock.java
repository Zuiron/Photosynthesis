...
public class WaterTroughBlock extends BlockWithEntity implements BlockEntityProvider {
    ...
    public void onStateReplaced(BlockState state, World world, BlockPos pos, BlockState newState, boolean moved) {
        if (state.getBlock() != newState.getBlock()) {
            ...
            if (blockEntity instanceof WaterTroughBlockEntity) {
                ItemScatterer.spawn(world, pos, (WaterTroughBlockEntity)blockEntity);
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos,
        ...
        if (!world.isClient) {
            NamedScreenHandlerFactory screenHandlerFactory = ((WaterTroughBlockEntity) world.getBlockEntity(pos));
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return checkType(type, ModBlockEntities.WATERTROUGH, WaterTroughBlockEntity::tick);
    }
}
