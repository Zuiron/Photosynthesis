...
public class FluidPressBlock extends BlockWithEntity implements BlockEntityProvider {
    public static final DirectionProperty FACING = Properties.HORIZONTAL_FACING;
    public static BooleanProperty LIT;
    public static BooleanProperty PROCESSING;

    public FluidPressBlock(Settings settings) {
        super(settings);
    ...
    public void onStateReplaced(BlockState state, World world, BlockPos pos, BlockState newState, boolean moved) {
        if (state.getBlock() != newState.getBlock()) {
            ...
            if (blockEntity instanceof FluidPressBlockEntity) {
                ItemScatterer.spawn(world, pos, (FluidPressBlockEntity)blockEntity);
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos,
        ...
        if (!world.isClient) {
            NamedScreenHandlerFactory screenHandlerFactory = ((FluidPressBlockEntity) world.getBlockEntity(pos));
    ...
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new FluidPressBlockEntity(pos, state);
    }

    @Nullable
    @Override
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return checkType(type, ModBlockEntities.FLUID_PRESS, FluidPressBlockEntity::tick);
    }
