...
public class EggBasketBlock extends BlockWithEntity implements BlockEntityProvider {
    ...
    public EggBasketBlock(Settings settings) {
        super(settings);
    }
    ...
    public void onStateReplaced(BlockState state, World world, BlockPos pos, BlockState newState, boolean moved) {
        if (state.getBlock() != newState.getBlock()) {
            ...
            if (blockEntity instanceof EggBasketBlockEntity) {
                ItemScatterer.spawn(world, pos, (EggBasketBlockEntity)blockEntity);
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos,
        ...
        if (!world.isClient) {
            NamedScreenHandlerFactory screenHandlerFactory = ((EggBasketBlockEntity) world.getBlockEntity(pos));
    ...
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new EggBasketBlockEntity(pos, state);
    }
