...
public class MilkSeperatorBlockEntity extends BlockEntity implements ExtendedScreenHandlerFactory, ImplementedInventory {
    ...
    private static boolean hasEmptyBucketInSlot(MilkSeperatorBlockEntity entity) {
    ...
    private static void extractFluidAndMakeBucket(MilkSeperatorBlockEntity entity) {
    ...
    private static boolean extractFluid(MilkSeperatorBlockEntity entity, int Amount) {
        try(Transaction transaction = Transaction.openOuter()) {
    ...
    private static boolean canInsertFluidIntoFluidOutput(MilkSeperatorBlockEntity entity, FluidStack outputFluid, long amount) {
