...
public class GravityPressRecipe implements Recipe<SimpleInventory> {
    ...
    public GravityPressRecipe(Identifier id, ItemStack output, DefaultedList<Ingredient> recipeItems, int cookingTime) {
        this.id = id;
        this.output = output;
    ...
    public static class Type implements RecipeType<GravityPressRecipe> {
        private Type() { }
        public static final Type INSTANCE = new Type();
        public static final String ID = "gravitypress";
    }

    public static class Serializer implements RecipeSerializer<GravityPressRecipe> {
        public static final Serializer INSTANCE = new Serializer();
        public static final String ID = "gravitypress";
        // this is the name given in the json file

        @Override
        public GravityPressRecipe read(Identifier id, JsonObject json) {
            ...
            return new GravityPressRecipe(id, output, inputs, CookTime);
        }

        @Override
        public GravityPressRecipe read(Identifier id, PacketByteBuf buf) {
        ...
        @Override
        public void write(PacketByteBuf buf, GravityPressRecipe recipe) {
