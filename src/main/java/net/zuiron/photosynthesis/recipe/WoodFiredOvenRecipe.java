...
public class WoodFiredOvenRecipe implements Recipe<SimpleInventory> {
    ...
    public WoodFiredOvenRecipe(Identifier id, ItemStack output, DefaultedList<Ingredient> recipeItems, int cookingTime, DefaultedList counts) {
        this.id = id;
        this.output = output;
    ...
    public static class Type implements RecipeType<WoodFiredOvenRecipe> {
        private Type() { }
        public static final Type INSTANCE = new Type();
        public static final String ID = "woodfiredoven";
    }
    ...
    public static class Serializer implements RecipeSerializer<WoodFiredOvenRecipe> {
        ...
        public WoodFiredOvenRecipe read(Identifier id, JsonObject json) {
            ...
            return new WoodFiredOvenRecipe(id, output, inputs, CookTime, counts);
        }
        ...
        @Override
        public void write(PacketByteBuf buf, WoodFiredOvenRecipe recipe) {
