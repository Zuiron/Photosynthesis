...
public class CropData {
    ...
    static {
        ...
        cropDataMap.put("block.photosynthesis.chanterelle_mushroom_crop",   new CropData(new int[]{7, 1, 2, 5}, new int[]{4, 0, 1, 2}));    //plant autumn, harvest summer.
        cropDataMap.put("block.photosynthesis.morel_mushroom_crop",         new CropData(new int[]{7, 1, 2, 5}, new int[]{4, 0, 1, 2}));    //plant autumn, harvest summer.
        ...
        cropDataMap.put("block.photosynthesis.floramelissia_crop",          new CropData(new int[]{5, 2, 4, 7}, new int[]{7, 0, 2, 4}));    //plant autumn, harvest spring.
        cropDataMap.put("block.photosynthesis.wither_rose_crop",            new CropData(new int[]{5, 2, 4, 7}, new int[]{7, 0, 2, 4}));    //plant autumn, harvest spring.
        ...
        cropDataMap.put("block.photosynthesis.red_grapetree_bushcrop",  new CropData(new int[]{7, 0, 0, 2}, new int[]{2, 7, 7, 0}));    //plant spring, harvest summer.
