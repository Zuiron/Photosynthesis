...
public class MapleExtractorScreenHandler extends ScreenHandler {
    private final Inventory inventory;
    private final PropertyDelegate propertyDelegate;
    public final MapleExtractorBlockEntity blockEntity;
    public FluidStack fluidStack;

    public MapleExtractorScreenHandler(int syncId, PlayerInventory inventory, PacketByteBuf buf) {
        //this(syncId, inventory, new SimpleInventory(2), new ArrayPropertyDelegate(2));
        this(syncId, inventory, inventory.player.getWorld().getBlockEntity(buf.readBlockPos()),
                new ArrayPropertyDelegate(2));
    }

    public MapleExtractorScreenHandler(int syncId, PlayerInventory playerInventory, BlockEntity entity, PropertyDelegate delegate) {
        super(ModScreenHandlers.MAPLE_EXTRACTOR_SCREEN_HANDLER, syncId);
