...
public class MapleExtractorScreen extends HandledScreen<MapleExtractorScreenHandler> {
    private static final Identifier TEXTURE =
            new Identifier(Photosynthesis.MOD_ID, "textures/gui/maple_extractor_gui.png");
    private FluidStackRenderer fluidStackRenderer;

    public MapleExtractorScreen(MapleExtractorScreenHandler handler, PlayerInventory inventory, Text title) {
