...
public class WaterTroughScreenHandler extends ScreenHandler {
    private final Inventory inventory;
    private final PropertyDelegate propertyDelegate;
    public final WaterTroughBlockEntity blockEntity;
    public FluidStack fluidStack;

    public WaterTroughScreenHandler(int syncId, PlayerInventory inventory, PacketByteBuf buf) {
        //this(syncId, inventory, new SimpleInventory(2), new ArrayPropertyDelegate(2));
        this(syncId, inventory, inventory.player.getWorld().getBlockEntity(buf.readBlockPos()),
                new ArrayPropertyDelegate(2));
    }

    public WaterTroughScreenHandler(int syncId, PlayerInventory playerInventory, BlockEntity entity, PropertyDelegate delegate) {
        super(ModScreenHandlers.WATERTROUGH_SCREEN_HANDLER, syncId);
        checkSize(((Inventory) entity), 2);
        this.inventory = (Inventory)entity;
        inventory.onOpen(playerInventory.player);
        this.propertyDelegate = delegate;
        this.blockEntity = (WaterTroughBlockEntity) entity;
