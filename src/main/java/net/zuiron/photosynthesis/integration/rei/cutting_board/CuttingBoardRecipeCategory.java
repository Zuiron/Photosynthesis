...
public class CuttingBoardRecipeCategory implements DisplayCategory<CuttingBoardRecipeDisplay> {
    private static final Identifier GUI_TEXTURE = new Identifier(Photosynthesis.MOD_ID, "textures/gui/cutting_board_gui_rei.png");

    @Override
    public Renderer getIcon() {
        return EntryStacks.of(ModBlocks.CUTTINGBOARD);
    }
    ...
    @Override
    public CategoryIdentifier<? extends CuttingBoardRecipeDisplay> getCategoryIdentifier() {
        return PhotosynthesisREI.CUTTINGBOARD;
    }

    @Override
    public List<Widget> setupDisplay(CuttingBoardRecipeDisplay display, Rectangle bounds) {
