package net.zuiron.photosynthesis.integration.rei.hayrack;
...
public class HayRackRecipeCategory implements DisplayCategory<HayRackRecipeDisplay> {
    private static final Identifier GUI_TEXTURE = new Identifier(Photosynthesis.MOD_ID, "textures/gui/hayrack_gui_rei.png");

    @Override
    public Renderer getIcon() {
        return EntryStacks.of(ModBlocks.HAYRACK);
    }

    @Override
    public Text getTitle() {
        //return Photosynthesis.i18n("rei.cooking");
        return Text.literal("Hay Rack");
    }

    @Override
    public CategoryIdentifier<? extends HayRackRecipeDisplay> getCategoryIdentifier() {
        return PhotosynthesisREI.HAYRACK;
    }

    @Override
    public List<Widget> setupDisplay(HayRackRecipeDisplay display, Rectangle bounds) {
