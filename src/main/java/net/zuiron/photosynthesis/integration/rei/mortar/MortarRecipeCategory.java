package net.zuiron.photosynthesis.integration.rei.mortar;
...
public class MortarRecipeCategory implements DisplayCategory<MortarRecipeDisplay> {
    private static final Identifier GUI_TEXTURE = new Identifier(Photosynthesis.MOD_ID, "textures/gui/mortar_gui_rei.png");
    ...
    public CategoryIdentifier<? extends MortarRecipeDisplay> getCategoryIdentifier() {
        return PhotosynthesisREI.MORTAR;
    }
